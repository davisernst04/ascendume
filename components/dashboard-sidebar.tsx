...
import { SidebarResumeDeleteButton } from "@/components/sidebar-resume-delete-button";
        ...
        <div className="flex-1 px-3 overflow-y-auto overflow-x-hidden">
          <div className="space-y-1 pb-4">
            ...
            {userResumes.map((resume) => (
              <div
                key={resume.id}
                className="group/resume-item flex items-center"
              >
                <Link href={`/${resume.id}`} className="flex-1 min-w-0">
                  <Button
                    variant="ghost"
                ...
                <SidebarResumeDeleteButton resumeId={resume.id} />
              </div>
            ))}
